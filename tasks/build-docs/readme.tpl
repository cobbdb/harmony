...
[![Build Status](https://travis-ci.org/cobbdb/harmony.svg?branch=7.2.0)](https://travis-ci.org/cobbdb/harmony)
...
-------------
##### [Link to full autodocs](https://cobbdb.github.io/harmony/7.2.0)
...
[Full docs are available here](https://cobbdb.github.io/harmony/7.2.0), but
